...
const JobListings = ({ userType = "general" }: JobListingsProps) => {
  ...
  const jobs: Job[] = [
    ...
    },
    {
      ...
      type: "Full-time",
      shift: "First Shift (6 AM - 2 PM)",
      description: "Operate forklifts in warehouse environment, load/unload trucks, maintain inventory accuracy.",
    ...
    },
    {
      ...
      salary: "$16-19/hour",
      type: "Full-time",
      shift: "Third Shift (10 PM - 6 AM)",
      description: "Assembly line production work, quality control, and equipment maintenance.",
    ...
    },
    {
      ...
      location: "Downtown Manufacturing",
      salary: "$22-28/hour",
      type: "Full-time",
      shift: "Second Shift (2 PM - 10 PM)",
      description: "Equipment maintenance, troubleshooting, and facility repairs.",
    ...
    },
    {
      ...
      description: "Security monitoring, access control, and incident reporting.",
    ...
    },
    {
      ...
      company: "Cafeteria Solutions",
      location: "Industrial Complex",
      salary: "$14-17/hour",
      type: "Part-time",
      shift: "First Shift (5 AM - 1 PM)",
      description: "Food preparation, serving, and kitchen maintenance in industrial cafeteria.",
    ...
    },
    {
      ...
      salary: "$13-16/hour",
      type: "Part-time",
      shift: "Evening Shift (6 PM - 10 PM)",
      description: "Office cleaning, sanitization, and facility maintenance.",
